...
import { Phone, ShieldCheck, Timer, ArrowRight, Wrench } from "lucide-react";
      ...
      <div className="relative max-w-7xl mx-auto px-5 md:px-8 grid lg:grid-cols-[1.1fr_0.9fr] gap-14 lg:gap-10 items-center">
        ...
        <div>
          ...
          <motion.div
            ...
            className="flex items-center gap-6 text-text-muted text-xs md:text-sm"
          >
            <span className="flex items-center gap-1.5"><ShieldCheck size={16} className="text-accent" /> Licensed &amp; Insured</span>
            <span className="flex items-center gap-1.5"><Timer size={16} className="text-accent" /> 45-Min Emergency Dispatch</span>
          </motion.div>
        </div>
